...
const playIdleVideo$ = $(() => {
    ...
    if (video.src &&
        video.src.includes('prs_daioff.idle.mp4') &&
        !video.paused &&
        !video.ended &&
    ...
    const fullVideoPath = window.location.origin + '/prs_daioff.idle.mp4';
    ...
    useVisibleTask$(async ({ cleanup }) => {
        ...
        try {
            ...
            if (history && history.length > 0) {
                ...
                chatHistory.push({
                    role: "assistant",
                    content: "Bienvenido/a al asistente virtual de DAI OFF. Puedes consultar sobre tus derechos laborales y cualquier cuestión legal relacionada."
                });
            }
        } catch (error) {
